...
_STUB_DEFS: list[tuple[int, str, list[str], str, list[str]]] = [
    (156, "SyntheticIdentityAccountOpening", ["entity"],
     "Opening accounts with AI-generated synthetic identities.", ["kyc_data"]),
    (157, "DeepfakeKYCInterviews", ["entity"],
    ...
    (159, "AIGeneratedShellWebsites", ["entity"],
     "AI-generated websites for fictitious shell companies.", ["domain_data"]),
    (160, "AIWrittenInvoicesContracts", ["entity"],
     "AI-authored invoices and contracts for fictitious transactions.", ["invoice_contract_metadata"]),
    ...
    (168, "ImageForgeryFinancialRecords", ["entity"],
     "AI image models forging or altering financial filings and credentials.", ["filing_image_metadata"]),
    ...
    (171, "SyntheticBeneficialOwnerNarratives", ["entity"],
