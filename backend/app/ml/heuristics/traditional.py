...
_STUB_DEFS: list[tuple[int, str, list[str], str, list[str]]] = [
    (2, "CashIntensiveFrontBusiness", ["behavioral"],
     "Front business generating anomalous cash revenue.", ["revenue_data"]),
    (3, "ComminglingRetailTills", ["behavioral"],
    ...
    (18, "CashPayrollPadding", ["behavioral"],
    ...
    (38, "PayrollProcessorAbuse", ["entity"],
    ...
    (60, "ArtworkValuationInflation", ["entity"],
    ...
    (64, "TrustFoundationOpacity", ["entity"],
    ...
    (66, "FalseShareholderLoans", ["entity"],
    ...
    (76, "RenovationInvoiceInflation", ["entity"],
    ...
    (79, "FranchiseFeeLaundering", ["entity"],
    ...
    (83, "TourismReceiptInflation", ["behavioral"],
    ...
    (87, "FreeTradeZoneConcealment", ["entity"],
    ...
    (89, "CrossBorderSalarySimulation", ["entity"],
     "Simulating salary payments across borders to move funds.", ["payroll_data"]),
    (90, "StudentTuitionLaundering", ["entity"],
